...
; ----------------------------------------------------------------------------
        ...
        jsr     LEC94                           ; A006 20 94 EC                  ..
        cmp     #$50                            ; A009 C9 50                    .P
        bcs     LA032                           ; A00B B0 25                    .%
LA00D:  lda     #$6D                            ; A00D A9 6D                    .m
        jsr     LEA98                           ; A00F 20 98 EA                  ..
        lda     #$1C                            ; A012 A9 1C                    ..
...
LA04F:  ldy     $0480,x                         ; A04F BC 80 04                 ...
        ...
        jsr     LEC16                           ; A05E 20 16 EC                  ..
        jsr     LEC30                           ; A061 20 30 EC                  0.
        jsr     LA089                           ; A064 20 89 A0                  ..
LA067:  jsr     LF16F                           ; A067 20 6F F1                  o.
        ...
        lda     #$6E                            ; A075 A9 6E                    .n
        jsr     LEAA4                           ; A077 20 A4 EA                  ..
        jsr     LA09D                           ; A07A 20 9D A0                  ..
        lda     #$08                            ; A07D A9 08                    ..
        jsr     LF470                           ; A07F 20 70 F4                  p.
        ldx     $0D                             ; A082 A6 0D                    ..
        dec     $0E                             ; A084 C6 0E                    ..
...
; ----------------------------------------------------------------------------
        jsr     LE968                           ; A0B2 20 68 E9                  h.
        jmp     LEA65                           ; A0B5 4C 65 EA                 Le.

; ----------------------------------------------------------------------------
        jsr     LEC16                           ; A0B8 20 16 EC                  ..
        jsr     LEC30                           ; A0BB 20 30 EC                  0.
...
LA0CD:  sta     $0570,x                         ; A0CD 9D 70 05                 .p.
        jsr     LEC94                           ; A0D0 20 94 EC                  ..
        cmp     #$50                            ; A0D3 C9 50                    .P
        bcs     LA0B1                           ; A0D5 B0 DA                    ..
        jsr     LEC76                           ; A0D7 20 76 EC                  v.
        cmp     #$14                            ; A0DA C9 14                    ..
...
LA16D:  stx     $0F                             ; A16D 86 0F                    ..
        ...
        asl     a                               ; A179 0A                       .
        sta     $0D                             ; A17A 85 0D                    ..
LA17C:  jsr     LF16F                           ; A17C 20 6F F1                  o.
...
; ----------------------------------------------------------------------------
        jsr     LEC94                           ; A2B9 20 94 EC                  ..
        cmp     #$50                            ; A2BC C9 50                    .P
        bcs     LA31E                           ; A2BE B0 5E                    .^
        jsr     LEC76                           ; A2C0 20 76 EC                  v.
        cmp     #$10                            ; A2C3 C9 10                    ..
        bcs     LA31E                           ; A2C5 B0 57                    .W
        lda     #$75                            ; A2C7 A9 75                    .u
        jsr     LEA98                           ; A2C9 20 98 EA                  ..
        lda     #$D7                            ; A2CC A9 D7                    ..
...
LA2F1:  cmp     #$02                            ; A2F1 C9 02                    ..
        ...
        lda     #$76                            ; A2F5 A9 76                    .v
        jsr     LEA98                           ; A2F7 20 98 EA                  ..
        lda     #$0A                            ; A2FA A9 0A                    ..
        sta     $0588,x                         ; A2FC 9D 88 05                 ...
        lda     #$A3                            ; A2FF A9 A3                    ..
        sta     $05A0,x                         ; A301 9D A0 05                 ...
        jsr     LEC16                           ; A304 20 16 EC                  ..
        jsr     LEC30                           ; A307 20 30 EC                  0.
        ldy     #$13                            ; A30A A0 13                    ..
        jsr     LE7B7                           ; A30C 20 B7 E7                  ..
        bcc     LA31E                           ; A30F 90 0D                    ..
        ldy     #$1A                            ; A311 A0 1A                    ..
        jsr     LEA3F                           ; A313 20 3F EA                  ?.
        jsr     L8526                           ; A316 20 26 85                  &.
        bcc     LA31E                           ; A319 90 03                    ..
        jsr     LEC4A                           ; A31B 20 4A EC                  J.
LA31E:  rts                                     ; A31E 60                       `
...
LA353:  jsr     LF16F                           ; A353 20 6F F1                  o.
        bcs     LA379                           ; A356 B0 21                    .!
        lda     #$87                            ; A358 A9 87                    ..
        sta     $0408,y                         ; A35A 99 08 04                 ...
        lda     #$78                            ; A35D A9 78                    .x
        jsr     LEAA4                           ; A35F 20 A4 EA                  ..
...
LA3E6:  jsr     LECC2                           ; A3E6 20 C2 EC                  ..
        tay                                     ; A3E9 A8                       .
        lda     #$38                            ; A3EA A9 38                    .8
        jsr     LF470                           ; A3EC 20 70 F4                  p.
LA3EF:  jsr     LEA65                           ; A3EF 20 65 EA                  e.
        jsr     LEA86                           ; A3F2 20 86 EA                  ..
        dec     $0468,x                         ; A3F5 DE 68 04                 .h.
        bne     LA43C                           ; A3F8 D0 42                    .B
        jsr     LECC2                           ; A3FA 20 C2 EC                  ..
        sta     $0D                             ; A3FD 85 0D                    ..
        lda     #$78                            ; A3FF A9 78                    .x
        sta     $0468,x                         ; A401 9D 68 04                 .h.
        stx     $0F                             ; A404 86 0F                    ..
        jsr     LF16F                           ; A406 20 6F F1                  o.
        ...
        ldx     $0E                             ; A427 A6 0E                    ..
        lda     #$08                            ; A429 A9 08                    ..
        jsr     LF470                           ; A42B 20 70 F4                  p.
        ldx     $0F                             ; A42E A6 0F                    ..
        rts                                     ; A430 60                       `

; ----------------------------------------------------------------------------
        jsr     LE94A                           ; A431 20 4A E9                  J.
...
; ----------------------------------------------------------------------------
        ldy     #$0E                            ; A498 A0 0E                    ..
        jsr     LEA3F                           ; A49A 20 3F EA                  ?.
        bcc     LA4DB                           ; A49D 90 3C                    .<
        jsr     LA089                           ; A49F 20 89 A0                  ..
        inc     $0E                             ; A4A2 E6 0E                    ..
        jsr     LA54D                           ; A4A4 20 4D A5                  M.
        lda     #$2B                            ; A4A7 A9 2B                    .+
        jsr     LEC5D                           ; A4A9 20 5D EC                  ].
LA4AC:  jsr     LF16F                           ; A4AC 20 6F F1                  o.
        ...
        sec                                     ; A4BD 38                       8
        sbc     $0E                             ; A4BE E5 0E                    ..
        jsr     LEAA4                           ; A4C0 20 A4 EA                  ..
        tya                                     ; A4C3 98                       .
        tax                                     ; A4C4 AA                       .
        ldy     $0F                             ; A4C5 A4 0F                    ..
        lda     #$08                            ; A4C7 A9 08                    ..
        jsr     LF470                           ; A4C9 20 70 F4                  p.
        ldx     $0D                             ; A4CC A6 0D                    ..
        inc     $0F                             ; A4CE E6 0F                    ..
        lda     $0F                             ; A4D0 A5 0F                    ..
        and     #$0F                            ; A4D2 29 0F                    ).
...
LA4EC:  jsr     LEFF8                           ; A4EC 20 F8 EF                  ..
        ...
        sta     $0E                             ; A505 85 0E                    ..
        stx     $0F                             ; A507 86 0F                    ..
LA509:  jsr     LF16F                           ; A509 20 6F F1                  o.
...
LA524:  lda     LA543,x                         ; A524 BD 43 A5                 .C.
        ldx     $0F                             ; A527 A6 0F                    ..
        jsr     LEAA4                           ; A529 20 A4 EA                  ..
        tya                                     ; A52C 98                       .
        tax                                     ; A52D AA                       .
        ldy     $0D                             ; A52E A4 0D                    ..
        lda     #$08                            ; A530 A9 08                    ..
        jsr     LF470                           ; A532 20 70 F4                  p.
        ldx     $0F                             ; A535 A6 0F                    ..
        dec     $0E                             ; A537 C6 0E                    ..
        lda     $0D                             ; A539 A5 0D                    ..
        sec                                     ; A53B 38                       8
...
; ----------------------------------------------------------------------------
LA54D:  jsr     LF2C4                           ; A54D 20 C4 F2                  ..
        lda     #$01                            ; A550 A9 01                    ..
        sta     $0300,x                         ; A552 9D 00 03                 ...
        lda     #$2B                            ; A555 A9 2B                    .+
        jsr     LEC5D                           ; A557 20 5D EC                  ].
        lda     #$42                            ; A55A A9 42                    .B
        jmp     LEA98                           ; A55C 4C 98 EA                 L..

; ----------------------------------------------------------------------------
        jsr     LF2FE                           ; A55F 20 FE F2                  ..
        lda     #$01                            ; A562 A9 01                    ..
        sta     $0300,y                         ; A564 99 00 03                 ...
        lda     #$42                            ; A567 A9 42                    .B
        jmp     LEAE9                           ; A569 4C E9 EA                 L..

; ----------------------------------------------------------------------------
LA56C:  jsr     LF2C4                           ; A56C 20 C4 F2                  ..
        lda     #$2F                            ; A56F A9 2F                    ./
        sta     $0300,x                         ; A571 9D 00 03                 ...
        lda     #$42                            ; A574 A9 42                    .B
        jmp     LEA98                           ; A576 4C 98 EA                 L..

; ----------------------------------------------------------------------------
        jsr     LA620                           ; A579 20 20 A6                   .
        bcc     LA5BD                           ; A57C 90 3F                    .?
        jsr     LEC16                           ; A57E 20 16 EC                  ..
        jsr     LEC30                           ; A581 20 30 EC                  0.
...
; ----------------------------------------------------------------------------
        ldy     #$17                            ; A64A A0 17                    ..
        jsr     LE7B7                           ; A64C 20 B7 E7                  ..
        bcc     LA68B                           ; A64F 90 3A                    .:
        ldy     #$1C                            ; A651 A0 1C                    ..
        jsr     LEA3F                           ; A653 20 3F EA                  ?.
        ...
        ldy     #$17                            ; A66C A0 17                    ..
        jsr     LE7B7                           ; A66E 20 B7 E7                  ..
        ror     $0F                             ; A671 66 0F                    f.
        ldy     #$1C                            ; A673 A0 1C                    ..
        jsr     LEA3F                           ; A675 20 3F EA                  ?.
        lda     $0F                             ; A678 A5 0F                    ..
        bpl     LA68B                           ; A67A 10 0F                    ..
        bcc     LA681                           ; A67C 90 03                    ..
        jsr     LEC4A                           ; A67E 20 4A EC                  J.
...
; ----------------------------------------------------------------------------
        ...
        ldy     #$17                            ; A69E A0 17                    ..
        jsr     LE7B7                           ; A6A0 20 B7 E7                  ..
        bcs     LA6A8                           ; A6A3 B0 03                    ..
        jmp     LEA65                           ; A6A5 4C 65 EA                 Le.
...
; ----------------------------------------------------------------------------
        ...
        jsr     LEC94                           ; A6DF 20 94 EC                  ..
        cmp     #$40                            ; A6E2 C9 40                    .@
        bcs     LA6D9                           ; A6E4 B0 F3                    ..
        jsr     LEC76                           ; A6E6 20 76 EC                  v.
        cmp     #$10                            ; A6E9 C9 10                    ..
        ...
        jsr     LEC16                           ; A6FC 20 16 EC                  ..
        jsr     LEC30                           ; A6FF 20 30 EC                  0.
...
; ----------------------------------------------------------------------------
LA7BA:  dex                                     ; A7BA CA                       .
LA7BB:  cmp     ($C0),y                         ; A7BB D1 C0                    ..
        cpy     $68BD                           ; A7BD CC BD 68                 ..h
        .byte   $04                             ; A7C0 04                       .
        beq     LA7C8                           ; A7C1 F0 05                    ..
        dec     $0468,x                         ; A7C3 DE 68 04                 .h.
        bne     LA82D                           ; A7C6 D0 65                    .e
LA7C8:  jsr     LEA1E                           ; A7C8 20 1E EA                  ..
        ...
        jsr     LE968                           ; A7DD 20 68 E9                  h.
        jsr     LEFF8                           ; A7E0 20 F8 EF                  ..
...
LA83F:  lda     $0558,x                         ; A83F BD 58 05                 .X.
        ...
        jmp     LEC4A                           ; A852 4C 4A EC                 LJ.

; ----------------------------------------------------------------------------
LA855:  lda     $0468,x                         ; A855 BD 68 04                 .h.
        pha                                     ; A858 48                       H
        jsr     LEA98                           ; A859 20 98 EA                  ..
        pla                                     ; A85C 68                       h
        and     #$01                            ; A85D 29 01                    ).
        tay                                     ; A85F A8                       .
...
LA870:  ldy     #$0D                            ; A870 A0 0D                    ..
        jsr     LE7B7                           ; A872 20 B7 E7                  ..
        bcc     LA88E                           ; A875 90 17                    ..
        ldy     #$10                            ; A877 A0 10                    ..
        jsr     LEA3F                           ; A879 20 3F EA                  ?.
...
LA88E:  lda     $0558,x                         ; A88E BD 58 05                 .X.
        ...
        lda     #$3D                            ; A8BA A9 3D                    .=
        jsr     LEC5D                           ; A8BC 20 5D EC                  ].
        stx     $0F                             ; A8BF 86 0F                    ..
        lda     #$02                            ; A8C1 A9 02                    ..
        sta     $0E                             ; A8C3 85 0E                    ..
LA8C5:  jsr     LF16F                           ; A8C5 20 6F F1                  o.
...
; ----------------------------------------------------------------------------
LA908:  .byte   $80                             ; A908 80                       .
        cpy     #$BD                            ; A909 C0 BD                    ..
        cli                                     ; A90B 58                       X
        ora     $C9                             ; A90C 05 C9                    ..
        asl     $0FF0,x                         ; A90E 1E F0 0F                 ...
        jsr     LEC94                           ; A911 20 94 EC                  ..
        cmp     #$30                            ; A914 C9 30                    .0
        bcs     LA964                           ; A916 B0 4C                    .L
        inc     $0558,x                         ; A918 FE 58 05                 .X.
        lda     #$3B                            ; A91B A9 3B                    .;
        jsr     LEC5D                           ; A91D 20 5D EC                  ].
        ldy     #$17                            ; A920 A0 17                    ..
        jsr     LE7B7                           ; A922 20 B7 E7                  ..
        bcc     LA964                           ; A925 90 3D                    .=
        lda     #$1F                            ; A927 A9 1F                    ..
        jsr     LEA98                           ; A929 20 98 EA                  ..
        lda     $0528,x                         ; A92C BD 28 05                 .(.
        and     #$BF                            ; A92F 29 BF                    ).
        sta     $0528,x                         ; A931 9D 28 05                 .(.
        jsr     LEC16                           ; A934 20 16 EC                  ..
        jsr     LEC30                           ; A937 20 30 EC                  0.
        lda     #$44                            ; A93A A9 44                    .D
        sta     $0588,x                         ; A93C 9D 88 05                 ...
        lda     #$A9                            ; A93F A9 A9                    ..
        sta     $05A0,x                         ; A941 9D A0 05                 ...
        ldy     #$17                            ; A944 A0 17                    ..
        jsr     LE7B7                           ; A946 20 B7 E7                  ..
        bcc     LA964                           ; A949 90 19                    ..
        ldy     #$1C                            ; A94B A0 1C                    ..
        jsr     LEA3F                           ; A94D 20 3F EA                  ?.
        bcc     LA964                           ; A950 90 12                    ..
        jsr     LF2C4                           ; A952 20 C4 F2                  ..
        lda     #$42                            ; A955 A9 42                    .B
        jsr     LEA98                           ; A957 20 98 EA                  ..
        lda     #$8C                            ; A95A A9 8C                    ..
...
LA965:  lda     #$80                            ; A965 A9 80                    ..
        ...
        jsr     LECC2                           ; A9AD 20 C2 EC                  ..
        tay                                     ; A9B0 A8                       .
        lda     #$18                            ; A9B1 A9 18                    ..
        jsr     LF470                           ; A9B3 20 70 F4                  p.
        lda     #$20                            ; A9B6 A9 20                    . 
        ...
        jsr     LEA65                           ; A9D4 20 65 EA                  e.
        jsr     LEA86                           ; A9D7 20 86 EA                  ..
...
; ----------------------------------------------------------------------------
LAA14:  jsr     LEC16                           ; AA14 20 16 EC                  ..
        jsr     LEC30                           ; AA17 20 30 EC                  0.
...
; ----------------------------------------------------------------------------
LAA70:  jsr     LF16F                           ; AA70 20 6F F1                  o.
...
LAB03:  dey                                     ; AB03 88                       .
        ...
        .byte   $64                             ; AB12 64                       d
        ldy     #$15                            ; AB13 A0 15                    ..
        jsr     LE7B7                           ; AB15 20 B7 E7                  ..
        bcc     LAB24                           ; AB18 90 0A                    ..
        ldy     #$16                            ; AB1A A0 16                    ..
        jsr     LEA3F                           ; AB1C 20 3F EA                  ?.
        bcc     LAB24                           ; AB1F 90 03                    ..
        jsr     LEC4A                           ; AB21 20 4A EC                  J.
LAB24:  rts                                     ; AB24 60                       `
...
; ----------------------------------------------------------------------------
        ...
        jsr     LECC2                           ; AB2F 20 C2 EC                  ..
        tay                                     ; AB32 A8                       .
        lda     #$38                            ; AB33 A9 38                    .8
        jsr     LF470                           ; AB35 20 70 F4                  p.
LAB38:  jsr     LEA65                           ; AB38 20 65 EA                  e.
        jsr     LEA86                           ; AB3B 20 86 EA                  ..
LAB3E:  rts                                     ; AB3E 60                       `
...
LAB4E:  jsr     LEC94                           ; AB4E 20 94 EC                  ..
        cmp     #$20                            ; AB51 C9 20                    . 
        bcs     LAB3E                           ; AB53 B0 E9                    ..
        jsr     LEC76                           ; AB55 20 76 EC                  v.
        cmp     #$18                            ; AB58 C9 18                    ..
...
LAC09:  .byte   $A3                             ; AC09 A3                       .
        ...
        brk                                     ; AC0D 00                       .
        brk                                     ; AC0E 00                       .
        jsr     LEC16                           ; AC0F 20 16 EC                  ..
        jsr     LEC30                           ; AC12 20 30 EC                  0.
        ...
        jsr     LEFF8                           ; AC25 20 F8 EF                  ..
        pla                                     ; AC28 68                       h
        sta     $0408,x                         ; AC29 9D 08 04                 ...
        bcs     LAC7D                           ; AC2C B0 4F                    .O
        lda     #$97                            ; AC2E A9 97                    ..
        jsr     LEA98                           ; AC30 20 98 EA                  ..
LAC33:  lda     $0570,x                         ; AC33 BD 70 05                 .p.
        ...
        lda     #$96                            ; AC43 A9 96                    ..
        jmp     LEA98                           ; AC45 4C 98 EA                 L..

; ----------------------------------------------------------------------------
LAC48:  jsr     LF16F                           ; AC48 20 6F F1                  o.
...
; ----------------------------------------------------------------------------
        ...
        jmp     LF2C4                           ; ACD8 4C C4 F2                 L..

; ----------------------------------------------------------------------------
LACDB:  ldy     #$21                            ; ACDB A0 21                    .!
        jsr     LE7B7                           ; ACDD 20 B7 E7                  ..
        bcc     LAD2B                           ; ACE0 90 49                    .I
        ldy     #$28                            ; ACE2 A0 28                    .(
        jsr     LEA3F                           ; ACE4 20 3F EA                  ?.
        bcc     LACEC                           ; ACE7 90 03                    ..
        jsr     LEC4A                           ; ACE9 20 4A EC                  J.
LACEC:  jsr     LEC94                           ; ACEC 20 94 EC                  ..
        cmp     #$20                            ; ACEF C9 20                    . 
        ...
        lda     #$07                            ; AD23 A9 07                    ..
        jsr     LEA98                           ; AD25 20 98 EA                  ..
        inc     $0540,x                         ; AD28 FE 40 05                 .@.
LAD2B:  rts                                     ; AD2B 60                       `

; ----------------------------------------------------------------------------
LAD2C:  stx     $0F                             ; AD2C 86 0F                    ..
        jsr     LF16F                           ; AD2E 20 6F F1                  o.
...
LAD90:  lda     $0570,x                         ; AD90 BD 70 05                 .p.
        ...
        jsr     LE9E1                           ; ADB6 20 E1 E9                  ..
        jsr     LE94A                           ; ADB9 20 4A E9                  J.
        lda     $0390,x                         ; ADBC BD 90 03                 ...
        beq     LAD7B                           ; ADBF F0 BA                    ..
        jmp     LF2C4                           ; ADC1 4C C4 F2                 L..
...
LAE8B:  jmp     LF2C4                           ; AE8B 4C C4 F2                 L..

; ----------------------------------------------------------------------------
LAE8E:  lda     LAF20,y                         ; AE8E B9 20 AF                 . .
        jsr     LEA98                           ; AE91 20 98 EA                  ..
        lda     #$00                            ; AE94 A9 00                    ..
...
LAEE5:  .byte   $17                             ; AEE5 17                       .
        ...
        pha                                     ; AEE9 48                       H
        lda     #$26                            ; AEEA A9 26                    .&
        jsr     LEC5D                           ; AEEC 20 5D EC                  ].
        jsr     LF363                           ; AEEF 20 63 F3                  c.
        lda     #$03                            ; AEF2 A9 03                    ..
...
LAF93:  lda     $1C                             ; AF93 A5 1C                    ..
        ...
        ldy     #$06                            ; AF97 A0 06                    ..
        jsr     LC4A1                           ; AF99 20 A1 C4                  ..
        lda     L0010                           ; AF9C A5 10                    ..
        cmp     #$30                            ; AF9E C9 30                    .0
        bne     LAFDB                           ; AFA0 D0 39                    .9
        lda     #$2B                            ; AFA2 A9 2B                    .+
        jsr     LEC5D                           ; AFA4 20 5D EC                  ].
        jsr     LF2C4                           ; AFA7 20 C4 F2                  ..
        lda     #$42                            ; AFAA A9 42                    .B
        jsr     LEA98                           ; AFAC 20 98 EA                  ..
...
LB0F0:  brk                                     ; B0F0 00                       .
        .byte   $DC                             ; B0F1 DC                       .
        .byte   $20                             ; B0F2 20                        
LB0F3:  and     LB0AF,y                         ; B0F3 39 AF B0                 9..
        bcs     LB09D                           ; B0F6 B0 A5                    ..
        .byte   $FC                             ; B0F8 FC                       .
        clc                                     ; B0F9 18                       .
        adc     #$80                            ; B0FA 69 80                    i.
...
LB158:  ldy     #$1B                            ; B158 A0 1B                    ..
        jsr     LC4A1                           ; B15A 20 A1 C4                  ..
        lda     L0010                           ; B15D A5 10                    ..
        and     #$10                            ; B15F 29 10                    ).
        bne     LB182                           ; B161 D0 1F                    ..
        ldy     #$17                            ; B163 A0 17                    ..
        jsr     LC4A1                           ; B165 20 A1 C4                  ..
...
LB188:  lda     $0540,x                         ; B188 BD 40 05                 .@.
        ...
        jsr     LEF87                           ; B1A8 20 87 EF                  ..
        bcs     LB187                           ; B1AB B0 DA                    ..
        jsr     LEC94                           ; B1AD 20 94 EC                  ..
        cmp     #$07                            ; B1B0 C9 07                    ..
...
; ----------------------------------------------------------------------------
        ...
        jsr     LEA98                           ; B1EE 20 98 EA                  ..
LB1F1:  ldy     #$17                            ; B1F1 A0 17                    ..
        jsr     LE7B7                           ; B1F3 20 B7 E7                  ..
...
LB39D:  dec     $0468,x                         ; B39D DE 68 04                 .h.
        ...
        jsr     LF2C4                           ; B3A2 20 C4 F2                  ..
        lda     #$42                            ; B3A5 A9 42                    .B
        jsr     LEA98                           ; B3A7 20 98 EA                  ..
        lda     #$C2                            ; B3AA A9 C2                    ..
...
LB3B2:  ora     ($02,x)                         ; B3B2 01 02                    ..
        ldy     #$1A                            ; B3B4 A0 1A                    ..
        jsr     LEA3F                           ; B3B6 20 3F EA                  ?.
        bcc     LB40A                           ; B3B9 90 4F                    .O
        lda     #$0F                            ; B3BB A9 0F                    ..
        sta     $5B                             ; B3BD 85 5B                    .[
        ldy     #$03                            ; B3BF A0 03                    ..
LB3C1:  lda     #$AD                            ; B3C1 A9 AD                    ..
        jsr     LEAA4                           ; B3C3 20 A4 EA                  ..
        lda     #$73                            ; B3C6 A9 73                    .s
...
LB429:  dec     $0468,x                         ; B429 DE 68 04                 .h.
        ...
        jsr     LF2C4                           ; B42E 20 C4 F2                  ..
        lda     #$01                            ; B431 A9 01                    ..
        sta     $0300,x                         ; B433 9D 00 03                 ...
        lda     #$42                            ; B436 A9 42                    .B
        jsr     LEA98                           ; B438 20 98 EA                  ..
LB43B:  rts                                     ; B43B 60                       `
...
LB45E:  lda     $0498,x                         ; B45E BD 98 04                 ...
        ...
        lda     #$41                            ; B46A A9 41                    .A
        jsr     LEC5D                           ; B46C 20 5D EC                  ].
LB46F:  inc     $0498,x                         ; B46F FE 98 04                 ...
        jsr     LEA65                           ; B472 20 65 EA                  e.
        jsr     LEA86                           ; B475 20 86 EA                  ..
        lda     $0390,x                         ; B478 BD 90 03                 ...
        beq     LB480                           ; B47B F0 03                    ..
        jsr     LF2C4                           ; B47D 20 C4 F2                  ..
LB480:  rts                                     ; B480 60                       `
...
LB4BE:  ldy     $0468,x                         ; B4BE BC 68 04                 .h.
        jsr     LE7B7                           ; B4C1 20 B7 E7                  ..
        bcc     LB4D5                           ; B4C4 90 0F                    ..
        lda     #$00                            ; B4C6 A9 00                    ..
        sta     $0480,x                         ; B4C8 9D 80 04                 ...
        ldy     #$1A                            ; B4CB A0 1A                    ..
        jsr     LEA3F                           ; B4CD 20 3F EA                  ?.
...
LB560:  lda     #$FF                            ; B560 A9 FF                    ..
        ...
        jsr     LF2C4                           ; B569 20 C4 F2                  ..
        lda     #$01                            ; B56C A9 01                    ..
        sta     $0300,x                         ; B56E 9D 00 03                 ...
        lda     #$42                            ; B571 A9 42                    .B
        jsr     LEA98                           ; B573 20 98 EA                  ..
...
LB6B6:  jsr     LEA65                           ; B6B6 20 65 EA                  e.
        jsr     LEA86                           ; B6B9 20 86 EA                  ..
...
LB711:  pla                                     ; B711 68                       h
        ...
        jsr     LEA65                           ; B71D 20 65 EA                  e.
        jsr     LEA86                           ; B720 20 86 EA                  ..
...
LB7B8:  dey                                     ; B7B8 88                       .
        ...
        jsr     LECC4                           ; B7E1 20 C4 EC                  ..
        tay                                     ; B7E4 A8                       .
        sta     $04B0,x                         ; B7E5 9D B0 04                 ...
        lda     #$40                            ; B7E8 A9 40                    .@
        jsr     LF470                           ; B7EA 20 70 F4                  p.
LB7ED:  rts                                     ; B7ED 60                       `

; ----------------------------------------------------------------------------
LB7EE:  jsr     LEC76                           ; B7EE 20 76 EC                  v.
        cmp     #$04                            ; B7F1 C9 04                    ..
        bcs     LB829                           ; B7F3 B0 34                    .4
        jsr     LEC94                           ; B7F5 20 94 EC                  ..
        cmp     #$04                            ; B7F8 C9 04                    ..
...
LBA6B:  jsr     LEA65                           ; BA6B 20 65 EA                  e.
        jsr     LEA86                           ; BA6E 20 86 EA                  ..
...
LBAA7:  jsr     LF16F                           ; BAA7 20 6F F1                  o.
        bcs     LBAD7                           ; BAAA B0 2B                    .+
        lda     #$39                            ; BAAC A9 39                    .9
        jsr     LEC5D                           ; BAAE 20 5D EC                  ].
        lda     #$B9                            ; BAB1 A9 B9                    ..
        jsr     LEAA4                           ; BAB3 20 A4 EA                  ..
        lda     #$01                            ; BAB6 A9 01                    ..
