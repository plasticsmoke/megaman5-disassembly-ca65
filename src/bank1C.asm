...
; =============================================================================
; BANK $1C (mapped at $8000) — BEHAVIOR ENGINE, DAMAGE ENGINE, SHARED AI
; =============================================================================
L0000           := $0000
L00DF           := $00DF
L4100           := $4100
...
; ----------------------------------------------------------------------------
L83BC:  .byte   $00,$0F,$80,$0F,$00,$F1,$80,$F1,$00,$87,$C0,$87,$00,$79,$40,$79 ; 83BC
L83CC:  .byte   $00,$01,$01,$01,$00,$FE,$FE,$FE,$00,$00,$00,$00,$00,$FF,$FF,$FF ; 83CC
L83DC:  .byte   $80,$F1,$00,$0F,$80,$0F,$00,$F1,$40,$79,$00,$87,$C0,$87,$00,$79 ; 83DC
L83EC:  .byte   $FE,$FE,$00,$01,$01,$01,$00,$FE,$FF,$FF,$00,$00,$00,$00,$00,$FF ; 83EC
...
; ----------------------------------------------------------------------------
L857E:  .byte   $AB,$12                         ; 857E
L8580:  .byte   $05,$07                         ; 8580
L8582:  .byte   $50,$35,$53,$B5,$A6,$C4,$0F,$90 ; 8582
L858A:  .byte   $03,$02,$01,$00,$02,$01,$01,$00,$B9,$B7,$85,$9D,$D8,$03,$B9,$BB ; 858A
        .byte   $85,$9D,$F0,$03,$B9,$BF,$85,$85,$03,$A9,$00,$85,$00,$85,$02,$20 ; 859A
        .byte   $2D,$F2,$A5,$04,$9D,$A8,$03,$A5,$05,$9D,$C0,$03,$60 ; 85AA

; ----------------------------------------------------------------------------
        .byte   $AB,$7B,$E6,$12,$05,$07,$04,$07,$2D,$3B,$27,$38 ; 85B7
L85C3:  .byte   $00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00 ; 85C3
        .byte   $03,$03,$04,$05,$06,$03,$06,$03,$06,$05,$06,$04,$04,$04,$00,$04 ; 85D3
        .byte   $08,$04,$00,$04,$00,$01,$04,$04,$04,$03,$06,$05,$04,$08,$00,$00 ; 85E3
        .byte   $00,$07,$03,$06,$06,$04,$04,$02,$00,$03,$04,$04,$03,$06,$05,$04 ; 85F3
        .byte   $1C,$00,$00,$04,$04,$00,$00,$06,$00,$00,$00,$00,$00,$00,$03,$0A ; 8603
        .byte   $04,$03,$03,$03,$04,$03,$04,$00,$02,$08,$06,$03,$05,$07,$05,$04 ; 8613
        .byte   $04,$04,$04,$05,$02,$02,$03,$03,$02,$06,$04,$05,$04,$00,$05,$06 ; 8623
        .byte   $01,$05,$00,$00,$00,$00,$00,$00,$00,$00,$05,$02,$05,$00,$05,$05 ; 8633
        .byte   $06,$05,$04,$05,$03,$04,$05,$04,$03,$05,$05,$05,$05,$05,$04,$04 ; 8643
        .byte   $05,$05,$05,$05,$04,$00,$05,$04,$05,$06,$06,$02,$08,$06,$05,$02 ; 8653
        .byte   $06,$06,$00,$00,$00,$06,$00,$05,$03,$00,$03,$06,$00,$00,$00,$00 ; 8663
        .byte   $00,$05,$06,$00,$00,$00,$00,$00,$00,$00,$00,$06,$04,$06,$06,$00 ; 8673
        .byte   $00,$00,$00,$00,$03,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00 ; 8683
        .byte   $00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00 ; 8693
        .byte   $00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00 ; 86A3
        .byte   $00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00 ; 86B3
; -----------------------------------------------------------------------------
...
; ----------------------------------------------------------------------------
; =============================================================================
; BEHAVIOR types $C9-$CF — inert (unused type ids)
; =============================================================================
        rts                                     ; 8A64 60                       `

; ----------------------------------------------------------------------------
; =============================================================================
; BEHAVIOR type $10 — carrier: spawns its type $11 turret rider $18px
; overhead (child slot in ent_param), then patrols, U-turning every 60
; frames; hits are run through the damage engine and on death the
; explosion is handed to the rider's slot
; =============================================================================
...
; ----------------------------------------------------------------------------
; =============================================================================
; BEHAVIOR type $11 — turret rider: mirrors the carrier's x/facing
; (parent slot in ent_param), moves on its own y velocity; fires via
; L8538 every $14 frames
; =============================================================================
...
; ----------------------------------------------------------------------------
; =============================================================================
; BEHAVIOR type $1B — sleeper: waits out ent_param, wakes when the
; player is within $50x/$20y; turn animation via poses $43-$45, then
; periodically spits a type $1C shot (preset $46, sound $3C); tracks
; its shot's slot and re-arms when it dies
; =============================================================================
        lda     #$00                            ; 8B61 A9 00                    ..
...
; ----------------------------------------------------------------------------
L8CB0:  .byte   $00,$04,$F8,$00,$08,$04         ; 8CB0
L8CB6:  .byte   $D5,$D4,$D8,$D8,$D4,$93         ; 8CB6
; =============================================================================
; BEHAVIOR types $1C/$3C/$51/$55/$61/$9D/$9F — straight flier: moves
; on stored velocity both axes, no tile collision (shots/simple movers)
; =============================================================================
...
; ----------------------------------------------------------------------------
; =============================================================================
; BEHAVIOR type $36 — pop-up turret: idles until the player is inside
; $60x/$20y for 60 frames (gravity-flip aware, pose $0D hidden/$0C
; open), then fires a 2-shot type $58 volley (preset $0E, up+down
; spread) and closes again
; =============================================================================
...
; ----------------------------------------------------------------------------
; =============================================================================
; BEHAVIOR types $2C/$37/$58/$65/$9B — horizontal mover: facing
; dispatch only (straight projectiles)
; =============================================================================
        jmp     entity_facing_dispatch                           ; 8DE2 4C 65 EA                 Le.

; ----------------------------------------------------------------------------
; =============================================================================
; BEHAVIOR type $13 — planter: advances until within 8px of the
; player's x, then stops and plants a type $14 drop (+ type $01 spawn
; flash), recovers and resumes (poses $28/$29)
; =============================================================================
...
; ----------------------------------------------------------------------------
; =============================================================================
; BEHAVIOR type $14 — planted drop: falls (extent 7); on landing
; continues at $1D:A54D
; =============================================================================
        ldy     #$07                            ; 8E57 A0 07                    ..
...
; ----------------------------------------------------------------------------
; =============================================================================
; BEHAVIOR type $2A — pod: faces the player through ent_var6 delay,
; opens over 60 frames, then releases its type $2D payload (preset
; $5A, mutual slot links) and turns into the empty shell (pose $7D,
; shape $C0); refills to pose $4D once the payload dies
; =============================================================================
...
; ----------------------------------------------------------------------------
; =============================================================================
; BEHAVIOR type $2D — released payload of the type $2A pod: on anim
; phase 5 switches to the armed form (pose $7C, shape $85) and chases;
; notifies the pod's slot when it dies
; =============================================================================
...
; ----------------------------------------------------------------------------
; =============================================================================
; BEHAVIOR type $17 — creeper: crawls with $01.01 velocity hugging the
; surface (probe $0B); blocked ahead -> waits $1E frames then reverses
; =============================================================================
        lda     #$01                            ; 8F5D A9 01                    ..
...
; ----------------------------------------------------------------------------
; =============================================================================
; BEHAVIOR type $19 — bomber: flies facing the player; when the
; distance octant is 6/$0A (over the target) switches to bombing pose
; $32 and drops type $1A bombs on anim phases 4/8/$0C, then recovers
; (pose $34)
; =============================================================================
...
; ----------------------------------------------------------------------------
; =============================================================================
; BEHAVIOR type $1A — dropped bomb: falls (extent 6); detonates via
; $1D:A54D on impact
; =============================================================================
        ldy     #$06                            ; 9011 A0 06                    ..
...
; ----------------------------------------------------------------------------
; =============================================================================
; BEHAVIOR type $12 — swooper: flies level facing the player; on a
; downward-diagonal octant (7/9) rears up (pose $30) and dives with
; sound $3B (shape $CC while diving)
; =============================================================================
...
; ----------------------------------------------------------------------------
; =============================================================================
; BEHAVIOR types $2F/$8C/$BC/$C2 — spark burst: chime $2B, then spawns
; type $01 sparks radially (preset $42 + direction step) in two waves;
; used for detonations (Napalm blast $C2) and the ending twinkles ($2F)
; =============================================================================
        lda     #$2B                            ; 9066 A9 2B                    .+
...
; ----------------------------------------------------------------------------
; =============================================================================
; BEHAVIOR type $30 — firework fountain: every $10 frames launches a
; type $2F twinkle (sound $2C, preset $42 spread), five in all, then
; despawns
; =============================================================================
...
; ----------------------------------------------------------------------------
; =============================================================================
; BEHAVIOR type $1F — inert
; =============================================================================
        rts                                     ; 90FA 60                       `

; ----------------------------------------------------------------------------
; =============================================================================
; BEHAVIOR type $15 — blink chaser: cycles hidden/visible on timers;
; while the player touches it it homes with 8-way velocity (speed $20,
; re-aimed every $1E frames inside $32x/$32y), else drifts diagonally
; at $01.0F re-facing on a $1E beat
; =============================================================================
...
; ----------------------------------------------------------------------------
; =============================================================================
; BEHAVIOR type $38 — camera-edge stalker: once the camera passes
; x=$140 it rides $70px behind the left edge; on its ent_param beat
; scans/launches from $91C9 (auto-scroll pressure enemy)
; =============================================================================
...
; ----------------------------------------------------------------------------
; =============================================================================
; BEHAVIOR type $39 — falling debris: anim pinned to phase 0 while it
; descends (preset $17, drift $1C); on impact becomes a type $01 burst
; (chime $2B)
; =============================================================================
        lda     #$00                            ; 923F A9 00                    ..
...
; ----------------------------------------------------------------------------
L9447:  .byte   $3D,$3D,$3D,$3C,$3E,$3C,$3D,$3D ; 9447
L944F:  .byte   $04,$04,$04,$05,$06,$07,$08,$08 ; 944F
L9457:  .byte   $01,$01,$01,$05,$04,$06,$02,$02 ; 9457
L945F:  .byte   $00,$00,$00,$6A,$00,$6A,$00,$00 ; 945F
L9467:  .byte   $02,$02,$02,$01,$00,$01,$02,$02 ; 9467
L946F:  .byte   $00,$00,$00,$6A,$00,$6A,$00,$00 ; 946F
L9477:  .byte   $00,$00,$00,$01,$02,$01,$00,$00 ; 9477
; =============================================================================
...
; ----------------------------------------------------------------------------
L959C:  .byte   $14,$14,$14,$78                 ; 959C
L95A0:  .byte   $0C,$0B,$0A,$09,$04,$05,$06,$07 ; 95A0
; =============================================================================
...
; ----------------------------------------------------------------------------
L9865:  .byte   $FC,$FC,$FC,$FC,$04,$04,$04,$04 ; 9865
L986D:  .byte   $C0,$D0,$D3,$D4                 ; 986D
