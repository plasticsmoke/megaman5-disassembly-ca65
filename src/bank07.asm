...
LA168:  lda     $03F0,x                         ; A168 BD F0 03                 ...
        ...
        jmp     LE9E1                           ; A170 4C E1 E9                 L..

; ----------------------------------------------------------------------------
LA173:  jsr     LE999                           ; A173 20 99 E9                  ..
        jsr     LE9E1                           ; A176 20 E1 E9                  ..
        lda     #$30                            ; A179 A9 30                    .0
...
LA1D0:  jsr     L850B                           ; A1D0 20 0B 85                  ..
        ...
        lda     #$31                            ; A1E5 A9 31                    .1
        jmp     LEA98                           ; A1E7 4C 98 EA                 L..

; ----------------------------------------------------------------------------
LA1EA:  stx     $0F                             ; A1EA 86 0F                    ..
        jsr     LF16F                           ; A1EC 20 6F F1                  o.
        bcs     LA244                           ; A1EF B0 53                    .S
        lda     #$87                            ; A1F1 A9 87                    ..
        sta     $0408,y                         ; A1F3 99 08 04                 ...
        .byte   $A9                             ; A1F6 A9                       .
LA1F7:  .byte   $82                             ; A1F7 82                       .
...
LA208:  lda     #$07                            ; A208 A9 07                    ..
        jsr     LEAF5                           ; A20A 20 F5 EA                  ..
        tya                                     ; A20D 98                       .
        tax                                     ; A20E AA                       .
        sta     $0E                             ; A20F 85 0E                    ..
        jsr     LECC2                           ; A211 20 C2 EC                  ..
        tay                                     ; A214 A8                       .
        lda     #$10                            ; A215 A9 10                    ..
        jsr     LF470                           ; A217 20 70 F4                  p.
        ldx     $0F                             ; A21A A6 0F                    ..
        rts                                     ; A21C 60                       `
...
LA245:  php                                     ; A245 08                       .
        ...
        .byte   $02                             ; A248 02                       .
        php                                     ; A249 08                       .
        ora     (L0004,x)                       ; A24A 01 04                    ..
        .byte   $02                             ; A24C 02                       .
        php                                     ; A24D 08                       .
        ora     (L0004,x)                       ; A24E 01 04                    ..
        .byte   $01                             ; A250 01                       .
LA251:  .byte   $04                             ; A251 04                       .
        .byte   $02                             ; A252 02                       .
        .byte   $04                             ; A253 04                       .
        .byte   $02                             ; A254 02                       .
        .byte   $04                             ; A255 04                       .
        ora     (L0004,x)                       ; A256 01 04                    ..
        ora     (L0004,x)                       ; A258 01 04                    ..
        .byte   $02                             ; A25A 02                       .
        .byte   $04                             ; A25B 04                       .
        .byte   $02                             ; A25C 02                       .
LA25D:  brk                                     ; A25D 00                       .
        ...
        brk                                     ; A260 00                       .
        brk                                     ; A261 00                       .
        bpl     LA264                           ; A262 10 00                    ..
LA264:  .byte   $3C                             ; A264 3C                       <
        brk                                     ; A265 00                       .
        brk                                     ; A266 00                       .
        brk                                     ; A267 00                       .
        brk                                     ; A268 00                       .
LA269:  brk                                     ; A269 00                       .
        ...
        brk                                     ; A273 00                       .
        .byte   $02                             ; A274 02                       .
LA275:  bne     LA1F7                           ; A275 D0 80                    ..
        .byte   $80                             ; A277 80                       .
        bmi     LA2AA                           ; A278 30 30                    00
        tay                                     ; A27A A8                       .
        tay                                     ; A27B A8                       .
        cli                                     ; A27C 58                       X
        cli                                     ; A27D 58                       X
        ...
        .byte   $80                             ; A27F 80                       .
        .byte   $D0                             ; A280 D0                       .
LA281:  .byte   $FF                             ; A281 FF                       .
        bne     LA2B6                           ; A282 D0 32                    .2
LA284:  ldy     #$A0                            ; A284 A0 A0                    ..
        .byte   $A0                             ; A286 A0                       .
LA287:  bvc     LA29D                           ; A287 50 14                    P.
        .byte   $14                             ; A289 14                       .
        jsr     LEA86                           ; A28A 20 86 EA                  ..
        jmp     LEA65                           ; A28D 4C 65 EA                 Le.

; ----------------------------------------------------------------------------
        lda     $0540,x                         ; A290 BD 40 05                 .@.
        beq     LA244                           ; A293 F0 AF                    ..
        jsr     LEC16                           ; A295 20 16 EC                  ..
        jsr     LEC94                           ; A298 20 94 EC                  ..
        ldy     #$00                            ; A29B A0 00                    ..
...
LA2F0:  dey                                     ; A2F0 88                       .
        ...
        lda     #$25                            ; A2F5 A9 25                    .%
        jmp     LEA98                           ; A2F7 4C 98 EA                 L..

; ----------------------------------------------------------------------------
LA2FA:  lda     #$00                            ; A2FA A9 00                    ..
        sta     $0570,x                         ; A2FC 9D 70 05                 .p.
        ldy     #$1C                            ; A2FF A0 1C                    ..
        jsr     LE7B7                           ; A301 20 B7 E7                  ..
        bcs     LA34A                           ; A304 B0 44                    .D
        ldy     #$1E                            ; A306 A0 1E                    ..
        jmp     LEA3F                           ; A308 4C 3F EA                 L?.
...
LA331:  lda     #$00                            ; A331 A9 00                    ..
        ...
        ldy     #$1C                            ; A336 A0 1C                    ..
        jsr     LE7B7                           ; A338 20 B7 E7                  ..
        bcs     LA34A                           ; A33B B0 0D                    ..
        ldy     #$1E                            ; A33D A0 1E                    ..
        jsr     LEA3F                           ; A33F 20 3F EA                  ?.
...
LA34A:  lda     #$02                            ; A34A A9 02                    ..
        ...
        jsr     LEC16                           ; A379 20 16 EC                  ..
        jsr     LEC30                           ; A37C 20 30 EC                  0.
        ldy     #$01                            ; A37F A0 01                    ..
...
LA3C7:  stx     $0F                             ; A3C7 86 0F                    ..
        ...
        lda     #$02                            ; A3CE A9 02                    ..
        sta     $0E                             ; A3D0 85 0E                    ..
LA3D2:  jsr     LF16F                           ; A3D2 20 6F F1                  o.
        ...
        lda     #$27                            ; A3E6 A9 27                    .'
        jsr     LEAA4                           ; A3E8 20 A4 EA                  ..
        tya                                     ; A3EB 98                       .
        tax                                     ; A3EC AA                       .
        ldy     $0E                             ; A3ED A4 0E                    ..
        lda     #$10                            ; A3EF A9 10                    ..
        jsr     LF470                           ; A3F1 20 70 F4                  p.
        ldx     $0F                             ; A3F4 A6 0F                    ..
        lda     $0E                             ; A3F6 A5 0E                    ..
        cmp     #$0E                            ; A3F8 C9 0E                    ..
...
LA403:  jsr     LECC2                           ; A403 20 C2 EC                  ..
        sta     $0E                             ; A406 85 0E                    ..
        jsr     LF16F                           ; A408 20 6F F1                  o.
        ...
        lda     #$26                            ; A417 A9 26                    .&
        jsr     LEAA4                           ; A419 20 A4 EA                  ..
        tya                                     ; A41C 98                       .
        tax                                     ; A41D AA                       .
        ldy     $0E                             ; A41E A4 0E                    ..
        lda     #$10                            ; A420 A9 10                    ..
        jsr     LF470                           ; A422 20 70 F4                  p.
        ldx     $0F                             ; A425 A6 0F                    ..
LA427:  rts                                     ; A427 60                       `

; ----------------------------------------------------------------------------
LA428:  cmp     ($0B),y                         ; A428 D1 0B                    ..
LA42A:  ldx     #$A3                            ; A42A A2 A3                    ..
LA42C:  .byte   $ED                             ; A42C ED                       .
        tay                                     ; A42D A8                       .
LA42E:  asl     $05                             ; A42E 06 05                    ..
LA430:  clv                                     ; A430 B8                       .
        .byte   $E2                             ; A431 E2                       .
LA432:  brk                                     ; A432 00                       .
        brk                                     ; A433 00                       .
        ldy     #$13                            ; A434 A0 13                    ..
        jsr     LEA52                           ; A436 20 52 EA                  R.
...
LA44B:  dec     $0468,x                         ; A44B DE 68 04                 .h.
        ...
        jsr     LEF87                           ; A450 20 87 EF                  ..
        bcs     LA427                           ; A453 B0 D2                    ..
        jsr     L82B8                           ; A455 20 B8 82                  ..
LA458:  jmp     LF2C4                           ; A458 4C C4 F2                 L..

; ----------------------------------------------------------------------------
        jsr     LEC16                           ; A45B 20 16 EC                  ..
        jsr     LEC30                           ; A45E 20 30 EC                  0.
...
; ----------------------------------------------------------------------------
        jsr     LEC16                           ; A4DA 20 16 EC                  ..
        jsr     LEC30                           ; A4DD 20 30 EC                  0.
        lda     #$00                            ; A4E0 A9 00                    ..
        ...
        lda     #$2B                            ; A4F7 A9 2B                    .+
        jsr     LEA98                           ; A4F9 20 98 EA                  ..
        jsr     LEC16                           ; A4FC 20 16 EC                  ..
        jsr     LEC30                           ; A4FF 20 30 EC                  0.
        ...
        lda     #$29                            ; A51F A9 29                    .)
        jmp     LEA98                           ; A521 4C 98 EA                 L..

; ----------------------------------------------------------------------------
LA524:  jsr     LF16F                           ; A524 20 6F F1                  o.
...
; ----------------------------------------------------------------------------
        ...
        ldy     #$1C                            ; A55D A0 1C                    ..
        jsr     LE7B7                           ; A55F 20 B7 E7                  ..
        bcs     LA569                           ; A562 B0 05                    ..
        ldy     #$1E                            ; A564 A0 1E                    ..
        jmp     LEA3F                           ; A566 4C 3F EA                 L?.
...
LA56E:  lda     $0570,x                         ; A56E BD 70 05                 .p.
        ...
        lda     #$2A                            ; A57F A9 2A                    .*
        jsr     LEA98                           ; A581 20 98 EA                  ..
LA584:  rts                                     ; A584 60                       `

; ----------------------------------------------------------------------------
LA585:  jsr     L10F0                           ; A585 20 F0 10                  ..
        cpx     #$20                            ; A588 E0 20                    . 
        cpy     #$40                            ; A58A C0 40                    .@
        .byte   $F0                             ; A58C F0                       .
LA58D:  brk                                     ; A58D 00                       .
...
; ----------------------------------------------------------------------------
LA605:  sta     ($9B,x)                         ; A605 81 9B                    ..
        .byte   $9C                             ; A607 9C                       .
LA608:  sta     ($87,x)                         ; A608 81 87                    ..
        brk                                     ; A60A 00                       .
        eor     $15FD                           ; A60B 4D FD 15                 M..
        .byte   $9F                             ; A60E 9F                       .
        eor     $F7,x                           ; A60F 55 F7                    U.
        .byte   $7F                             ; A611 7F                       .
        .byte   $CF                             ; A612 CF                       .
        eor     #$93                            ; A613 49 93                    I.
        adc     $BE,x                           ; A615 75 BE                    u.
        cmp     $F7,x                           ; A617 D5 F7                    ..
        .byte   $47                             ; A619 47                       G
        .byte   $EF                             ; A61A EF                       .
        adc     ($EE,x)                         ; A61B 61 EE                    a.
        .byte   $74                             ; A61D 74                       t
        dec     $777D,x                         ; A61E DE 7D 77                 .}w
        .byte   $5F                             ; A621 5F                       _
        .byte   $DF                             ; A622 DF                       .
        eor     ($F1),y                         ; A623 51 F1                    Q.
        eor     $FD,x                           ; A625 55 FD                    U.
        eor     $FF,x                           ; A627 55 FF                    U.
        sbc     $DF,x                           ; A629 F5 DF                    ..
        .byte   $77                             ; A62B 77                       w
        sbc     $9FD5,y                         ; A62C F9 D5 9F                 ...
        adc     $6DBE,x                         ; A62F 7D BE 6D                 }.m
        .byte   $72                             ; A632 72                       r
        inx                                     ; A633 E8                       .
        inc     $7F,x                           ; A634 F6 7F                    ..
        .byte   $CF                             ; A636 CF                       .
        sbc     $7FBE,y                         ; A637 F9 BE 7F                 ...
        cmp     $FA25,x                         ; A63A DD 25 FA                 .%.
        cmp     $77CD                           ; A63D CD CD 77                 ..w
        .byte   $FF                             ; A640 FF                       .
        eor     $575F,x                         ; A641 5D 5F 57                 ]_W
        .byte   $FF                             ; A644 FF                       .
        cmp     $D5F4,x                         ; A645 DD F4 D5                 ...
        inc     $EF45                           ; A648 EE 45 EF                 .E.
        cmp     $D5EB,y                         ; A64B D9 EB D5                 ...
        ror     a                               ; A64E 6A                       j
        .byte   $87                             ; A64F 87                       .
        .byte   $3F                             ; A650 3F                       ?
        .byte   $5F                             ; A651 5F                       _
        .byte   $E7                             ; A652 E7                       .
        eor     $77FB,x                         ; A653 5D FB 77                 ].w
        ror     $DF51,x                         ; A656 7E 51 DF                 ~Q.
        eor     $DD                             ; A659 45 DD                    E.
        adc     $FA,x                           ; A65B 75 FA                    u.
        .byte   $34                             ; A65D 34                       4
        ldx     $50,y                           ; A65E B6 50                    .P
        sbc     $EFF5,y                         ; A660 F9 F5 EF                 ...
        ora     $54DD,x                         ; A663 1D DD 54                 ..T
        adc     $F2EC,x                         ; A666 7D EC F2                 }..
        and     $FF,x                           ; A669 35 FF                    5.
        .byte   $77                             ; A66B 77                       w
        .byte   $8F                             ; A66C 8F                       .
        sta     ($E7),y                         ; A66D 91 E7                    ..
        .byte   $7F                             ; A66F 7F                       .
        ...
        eor     $FB                             ; A681 45 FB                    E.
        .byte   $52                             ; A683 52                       R
        eor     $58,x                           ; A684 55 58                    UX
        lsr     $63,x                           ; A686 56 63                    Vc
        .byte   $77                             ; A688 77                       w
        cmp     $D5                             ; A689 C5 D5                    ..
        eor     ($FF),y                         ; A68B 51 FF                    Q.
        adc     $5DF6,x                         ; A68D 7D F6 5D                 }.]
        sbc     $D771,x                         ; A690 FD 71 D7                 .q.
        eor     $55FB,y                         ; A693 59 FB 55                 Y.U
        ldx     $EFB9,y                         ; A696 BE B9 EF                 ...
        .byte   $FC                             ; A699 FC                       .
        .byte   $7F                             ; A69A 7F                       .
        adc     ($EA),y                         ; A69B 71 EA                    q.
        .byte   $47                             ; A69D 47                       G
        sbc     $EF59,x                         ; A69E FD 59 EF                 .Y.
        .byte   $E7                             ; A6A1 E7                       .
        .byte   $6F                             ; A6A2 6F                       o
        .byte   $DD                             ; A6A3 DD                       .
        .byte   $B7                             ; A6A4 B7                       .
LA6A5:  adc     $F5F6,x                         ; A6A5 7D F6 F5                 }..
        sbc     $FFCD,x                         ; A6A8 FD CD FF                 ...
        .byte   $57                             ; A6AB 57                       W
        .byte   $EB                             ; A6AC EB                       .
        .byte   $F7                             ; A6AD F7                       .
        .byte   $FB                             ; A6AE FB                       .
        ora     $B7,x                           ; A6AF 15 B7                    ..
        .byte   $6F                             ; A6B1 6F                       o
        adc     $FFF5,x                         ; A6B2 7D F5 FF                 }..
        adc     $FF,x                           ; A6B5 75 FF                    u.
        .byte   $7F                             ; A6B7 7F                       .
        lda     $EF5F,x                         ; A6B8 BD 5F EF                 ._.
        eor     $FB,x                           ; A6BB 55 FB                    U.
        and     $FB,x                           ; A6BD 35 FB                    5.
        cmp     $5F,x                           ; A6BF D5 5F                    ._
        eor     $47,x                           ; A6C1 55 47                    UG
        sbc     $39F9,x                         ; A6C3 FD F9 39                 ..9
        sbc     $DF55,y                         ; A6C6 F9 55 DF                 .U.
        .byte   $5C                             ; A6C9 5C                       \
        inc     $F77D,x                         ; A6CA FE 7D F7                 .}.
        sta     ($7B),y                         ; A6CD 91 7B                    .{
        .byte   $5F                             ; A6CF 5F                       _
        lda     $FF7F                           ; A6D0 AD 7F FF                 ...
        .byte   $E7                             ; A6D3 E7                       .
        .byte   $AF                             ; A6D4 AF                       .
        sbc     $FF,x                           ; A6D5 F5 FF                    ..
        sta     $F9,x                           ; A6D7 95 F9                    ..
        ora     $F8,x                           ; A6D9 15 F8                    ..
        .byte   $F7                             ; A6DB F7                       .
        sbc     $FBD5,y                         ; A6DC F9 D5 FB                 ...
        adc     $FF,x                           ; A6DF 75 FF                    u.
        ror     $FF,x                           ; A6E1 76 FF                    v.
        .byte   $7C                             ; A6E3 7C                       |
        .byte   $F7                             ; A6E4 F7                       .
        .byte   $9F                             ; A6E5 9F                       .
        .byte   $7F                             ; A6E6 7F                       .
        .byte   $54                             ; A6E7 54                       T
        .byte   $FF                             ; A6E8 FF                       .
        lsr     $75F7,x                         ; A6E9 5E F7 75                 ^.u
        inc     $FFF9,x                         ; A6EC FE F9 FF                 ...
        adc     $EF,x                           ; A6EF 75 EF                    u.
        adc     $55DF,y                         ; A6F1 79 DF 55                 y.U
        .byte   $BF                             ; A6F4 BF                       .
        ror     LA1FF,x                         ; A6F5 7E FF A1                 ~..
        ldx     LB2F5,y                         ; A6F8 BE F5 B2                 ...
        adc     $FF,x                           ; A6FB 75 FF                    u.
        ora     $7F                             ; A6FD 05 7F                    ..
        adc     $D6BF                           ; A6FF 6D BF D6                 m..
        .byte   $EF                             ; A702 EF                       .
        .byte   $9F                             ; A703 9F                       .
        lsr     $EA51                           ; A704 4E 51 EA                 NQ.
        .byte   $44                             ; A707 44                       D
        .byte   $EF                             ; A708 EF                       .
        .byte   $57                             ; A709 57                       W
        sbc     $FF94                           ; A70A ED 94 FF                 ...
        .byte   $5D                             ; A70D 5D                       ]
LA70E:  .byte   $FB                             ; A70E FB                       .
        .byte   $77                             ; A70F 77                       w
        ldx     #$64                            ; A710 A2 64                    .d
        sed                                     ; A712 F8                       .
        .byte   $FC                             ; A713 FC                       .
        ...
        .byte   $53                             ; A719 53                       S
        .byte   $FB                             ; A71A FB                       .
        cmp     $04F5                           ; A71B CD F5 04                 ...
        .byte   $FF                             ; A71E FF                       .
        .byte   $EF                             ; A71F EF                       .
        .byte   $3C                             ; A720 3C                       <
        .byte   $63                             ; A721 63                       c
        .byte   $FF                             ; A722 FF                       .
        bvc     LA70E                           ; A723 50 E9                    P.
        .byte   $12                             ; A725 12                       .
        ror     LBF05,x                         ; A726 7E 05 BF                 ~..
        adc     $75FF,x                         ; A729 7D FF 75                 }.u
        .byte   $DF                             ; A72C DF                       .
        eor     $FD                             ; A72D 45 FD                    E.
        eor     $FB                             ; A72F 45 FB                    E.
        ora     $9F,x                           ; A731 15 9F                    ..
        ...
        .byte   $7F                             ; A734 7F                       .
        .byte   $37                             ; A735 37                       7
        sbc     $7BBD                           ; A736 ED BD 7B                 ..{
        .byte   $D7                             ; A739 D7                       .
        .byte   $F7                             ; A73A F7                       .
        .byte   $37                             ; A73B 37                       7
        .byte   $BF                             ; A73C BF                       .
        .byte   $57                             ; A73D 57                       W
        inc     $F353,x                         ; A73E FE 53 F3                 .S.
        .byte   $13                             ; A741 13                       .
        sbc     $57,x                           ; A742 F5 57                    .W
        .byte   $BF                             ; A744 BF                       .
        eor     $457F,x                         ; A745 5D 7F 45                 ].E
        inc     $FF56,x                         ; A748 FE 56 FF                 .V.
        eor     $FD,x                           ; A74B 55 FD                    U.
        .byte   $A7                             ; A74D A7                       .
        .byte   $6B                             ; A74E 6B                       k
        sta     $D5,x                           ; A74F 95 D5                    ..
        .byte   $5F                             ; A751 5F                       _
LA752:  .byte   $EF                             ; A752 EF                       .
        and     $FF,x                           ; A753 35 FF                    5.
        bne     LA752                           ; A755 D0 FB                    ..
        .byte   $1F                             ; A757 1F                       .
        inc     $FFCD,x                         ; A758 FE CD FF                 ...
        ora     $F7,x                           ; A75B 15 F7                    ..
        sbc     $FF                             ; A75D E5 FF                    ..
        .byte   $44                             ; A75F 44                       D
        lda     $F75D,x                         ; A760 BD 5D F7                 .].
        adc     $FF,x                           ; A763 75 FF                    u.
        .byte   $5F                             ; A765 5F                       _
        .byte   $EF                             ; A766 EF                       .
        lsr     $DE,x                           ; A767 56 DE                    V.
        cmp     $DB,x                           ; A769 D5 DB                    ..
        bvc     LA7EC                           ; A76B 50 7F                    P.
        .byte   $D3                             ; A76D D3                       .
        .byte   $FB                             ; A76E FB                       .
        .byte   $DF                             ; A76F DF                       .
        dec     $FF5E                           ; A770 CE 5E FF                 .^.
        .byte   $1F                             ; A773 1F                       .
        .byte   $FF                             ; A774 FF                       .
        eor     $DE,x                           ; A775 55 DE                    U.
        cmp     ($BB,x)                         ; A777 C1 BB                    ..
        adc     $BC,x                           ; A779 75 BC                    u.
        dec     $B7,x                           ; A77B D6 B7                    ..
        eor     $FD,x                           ; A77D 55 FD                    U.
        eor     $B7,x                           ; A77F 55 B7                    U.
        adc     $AF,x                           ; A781 75 AF                    u.
        .byte   $77                             ; A783 77                       w
        .byte   $FF                             ; A784 FF                       .
        sty     $3B,x                           ; A785 94 3B                    .;
        .byte   $47                             ; A787 47                       G
        ...
        .byte   $EF                             ; A7A0 EF                       .
        .byte   $50                             ; A7A1 50                       P
LA7A2:  .byte   $FF                             ; A7A2 FF                       .
        eor     $FB,x                           ; A7A3 55 FB                    U.
        and     $BD,x                           ; A7A5 35 BD                    5.
        eor     $FF                             ; A7A7 45 FF                    E.
        eor     $53BF,x                         ; A7A9 5D BF 53                 ].S
        .byte   $F7                             ; A7AC F7                       .
        eor     ($BF,x)                         ; A7AD 41 BF                    A.
        sbc     $F7,x                           ; A7AF F5 F7                    ..
        .byte   $57                             ; A7B1 57                       W
        .byte   $DF                             ; A7B2 DF                       .
        .byte   $F4                             ; A7B3 F4                       .
        sbc     $7955,y                         ; A7B4 F9 55 79                 .Uy
        .byte   $77                             ; A7B7 77                       w
        inc     $FD4D,x                         ; A7B8 FE 4D FD                 .M.
        .byte   $37                             ; A7BB 37                       7
        .byte   $FF                             ; A7BC FF                       .
        .byte   $7F                             ; A7BD 7F                       .
        ldx     $8955                           ; A7BE AE 55 89                 .U.
        .byte   $5B                             ; A7C1 5B                       [
        sbc     $FF55,x                         ; A7C2 FD 55 FF                 .U.
        eor     $5DED,y                         ; A7C5 59 ED 5D                 Y.]
        .byte   $FB                             ; A7C8 FB                       .
        .byte   $4F                             ; A7C9 4F                       O
        .byte   $F7                             ; A7CA F7                       .
        adc     $BC,x                           ; A7CB 75 BC                    u.
        and     ($DC,x)                         ; A7CD 21 DC                    !.
        eor     ($7E),y                         ; A7CF 51 7E                    Q~
        eor     $FE,x                           ; A7D1 55 FE                    U.
        .byte   $97                             ; A7D3 97                       .
        .byte   $EF                             ; A7D4 EF                       .
        .byte   $1C                             ; A7D5 1C                       .
        .byte   $97                             ; A7D6 97                       .
        ...
        .byte   $D7                             ; A7DB D7                       .
        .byte   $F7                             ; A7DC F7                       .
        cmp     $13E2                           ; A7DD CD E2 13                 ...
        inc     $FAD3,x                         ; A7E0 FE D3 FA                 ...
        .byte   $7F                             ; A7E3 7F                       .
        .byte   $FB                             ; A7E4 FB                       .
        lda     $53FF,x                         ; A7E5 BD FF 53                 ..S
        dec     $EF55,x                         ; A7E8 DE 55 EF                 .U.
        .byte   $55                             ; A7EB 55                       U
LA7EC:  .byte   $FF                             ; A7EC FF                       .
        .byte   $77                             ; A7ED 77                       w
        .byte   $FB                             ; A7EE FB                       .
        adc     $E7FD,x                         ; A7EF 7D FD E7                 }..
        .byte   $FF                             ; A7F2 FF                       .
        .byte   $DF                             ; A7F3 DF                       .
        .byte   $FF                             ; A7F4 FF                       .
        jmp     L1D7F                           ; A7F5 4C 7F 1D                 L..

; ----------------------------------------------------------------------------
        .byte   $DF                             ; A7F8 DF                       .
        sed                                     ; A7F9 F8                       .
        .byte   $E7                             ; A7FA E7                       .
        eor     $47FF,y                         ; A7FB 59 FF 47                 Y.G
        .byte   $97                             ; A7FE 97                       .
        .byte   $77                             ; A7FF 77                       w
        brk                                     ; A800 00                       .
        brk                                     ; A801 00                       .
...
LB4E3:  brk                                     ; B4E3 00                       .
        ...
        ldy     #$91                            ; B524 A0 91                    ..
        tay                                     ; B526 A8                       .
        sta     LA498,y                         ; B527 99 98 A4                 ...
        tya                                     ; B52A 98                       .
        sta     LA6A5,y                         ; B52B 99 A5 A6                 ...
        txs                                     ; B52E 9A                       .
        .byte   $9B                             ; B52F 9B                       .
        ldx     $B7,y                           ; B530 B6 B7                    ..
