...
; ----------------------------------------------------------------------------
        ...
        jsr     LEAA4                           ; A017 20 A4 EA                  ..
        lda     #$AD                            ; A01A A9 AD                    ..
        .byte   $99                             ; A01C 99                       .
        brk                                     ; A01D 00                       .
LA01E:  .byte   $03                             ; A01E 03                       .
        lda     #$59                            ; A01F A9 59                    .Y
        jsr     LEA98                           ; A021 20 98 EA                  ..
        lda     #$56                            ; A024 A9 56                    .V
...
LA047:  jsr     LE94A                           ; A047 20 4A E9                  J.
        lda     $0390,x                         ; A04A BD 90 03                 ...
        beq     LA052                           ; A04D F0 03                    ..
        jsr     LF2C4                           ; A04F 20 C4 F2                  ..
LA052:  rts                                     ; A052 60                       `
...
LA06E:  sta     $0604,y                         ; A06E 99 04 06                 ...
        ...
        sty     $18                             ; A077 84 18                    ..
        jsr     LF16F                           ; A079 20 6F F1                  o.
        bcs     LA0F3                           ; A07C B0 75                    .u
        lda     #$00                            ; A07E A9 00                    ..
        jsr     LEAA4                           ; A080 20 A4 EA                  ..
        lda     #$30                            ; A083 A9 30                    .0
...
LA0FB:  sta     $0600,y                         ; A0FB 99 00 06                 ...
        .byte   $99                             ; A0FE 99                       .
        .byte   $20                             ; A0FF 20                        
LA100:  asl     $88                             ; A100 06 88                    ..
        bpl     LA0FB                           ; A102 10 F7                    ..
        sty     $18                             ; A104 84 18                    ..
        jsr     LF2C4                           ; A106 20 C4 F2                  ..
        lda     #$00                            ; A109 A9 00                    ..
        jsr     LEA98                           ; A10B 20 98 EA                  ..
        lda     #$30                            ; A10E A9 30                    .0
...
LA1A0:  lda     #$C5                            ; A1A0 A9 C5                    ..
        ...
        jsr     LF2C4                           ; A1B5 20 C4 F2                  ..
        lda     #$B0                            ; A1B8 A9 B0                    ..
        sta     $0300,x                         ; A1BA 9D 00 03                 ...
        lda     #$74                            ; A1BD A9 74                    .t
        jsr     LEA98                           ; A1BF 20 98 EA                  ..
        jmp     LEA1E                           ; A1C2 4C 1E EA                 L..
...
; ----------------------------------------------------------------------------
        ...
        jsr     LF16F                           ; A1FB 20 6F F1                  o.
        lda     #$6C                            ; A1FE A9 6C                    .l
        jsr     LEAA4                           ; A200 20 A4 EA                  ..
        .byte   $B9                             ; A203 B9                       .
LA204:  plp                                     ; A204 28                       (
        ora     $29                             ; A205 05 29                    .)
        .byte   $DF                             ; A207 DF                       .
LA208:  sta     $0528,y                         ; A208 99 28 05                 .(.
        ...
        tax                                     ; A234 AA                       .
        .byte   $BD                             ; A235 BD                       .
LA236:  sbc     $85A3                           ; A236 ED A3 85                 ...
        .byte   $03                             ; A239 03                       .
        sty     $0F                             ; A23A 84 0F                    ..
        jsr     LF22D                           ; A23C 20 2D F2                  -.
        ldy     $0F                             ; A23F A4 0F                    ..
        ldx     $A6                             ; A241 A6 A6                    ..
        lda     $04                             ; A243 A5 04                    ..
...
LA34F:  ora     $A9                             ; A34F 05 A9                    ..
        ...
        jsr     LF16F                           ; A35C 20 6F F1                  o.
        bcs     LA375                           ; A35F B0 14                    ..
        lda     #$21                            ; A361 A9 21                    .!
        jsr     LEAA4                           ; A363 20 A4 EA                  ..
...
; ----------------------------------------------------------------------------
        ...
        sta     $55                             ; A4A0 85 55                    .U
        .byte   $A9                             ; A4A2 A9                       .
LA4A3:  ora     (L0020,x)                       ; A4A3 01 20                    . 
        .byte   $B7                             ; A4A5 B7                       .
        .byte   $FF                             ; A4A6 FF                       .
        jmp     LF2C4                           ; A4A7 4C C4 F2                 L..
...
; ----------------------------------------------------------------------------
        ...
        jsr     LF16F                           ; A4FA 20 6F F1                  o.
        bcs     LA51A                           ; A4FD B0 1B                    ..
        lda     #$62                            ; A4FF A9 62                    .b
        jsr     LEAA4                           ; A501 20 A4 EA                  ..
...
LA578:  sta     $060C,y                         ; A578 99 0C 06                 ...
        ...
        sty     $18                             ; A581 84 18                    ..
        jsr     LF16F                           ; A583 20 6F F1                  o.
        bcs     LA5A8                           ; A586 B0 20                    . 
        lda     #$42                            ; A588 A9 42                    .B
        jsr     LEAA4                           ; A58A 20 A4 EA                  ..
        lda     #$2F                            ; A58D A9 2F                    ./
...
; ----------------------------------------------------------------------------
LA672:  .byte   $0F                             ; A672 0F                       .
        bit     $14                             ; A673 24 14                    $.
        .byte   $03                             ; A675 03                       .
        jsr     LEF87                           ; A676 20 87 EF                  ..
...
LA687:  lda     $0330,x                         ; A687 BD 30 03                 .0.
        ...
        jsr     LF2C4                           ; A69B 20 C4 F2                  ..
LA69E:  rts                                     ; A69E 60                       `

; ----------------------------------------------------------------------------
        jsr     LEF87                           ; A69F 20 87 EF                  ..
...
; ----------------------------------------------------------------------------
        ...
        .byte   $FF                             ; A715 FF                       .
        .byte   $FF                             ; A716 FF                       .
        sbc     $F7FF,x                         ; A717 FD FF F7                 ...
        .byte   $FF                             ; A71A FF                       .
        .byte   $DF                             ; A71B DF                       .
        .byte   $FF                             ; A71C FF                       .
        .byte   $FF                             ; A71D FF                       .
        .byte   $FF                             ; A71E FF                       .
        cmp     $FFFF,x                         ; A71F DD FF FF                 ...
        .byte   $FF                             ; A722 FF                       .
        cmp     $FF,x                           ; A723 D5 FF                    ..
        .byte   $FF                             ; A725 FF                       .
        .byte   $FF                             ; A726 FF                       .
